...
export class McpServerManager {
	...
	private static providers: Set<AfxProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: AfxProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: AfxProvider): void {
