...
import { getGlobalAfxDirectory, getProjectAfxDirectoryForCwd } from "../afx-config"
...
export async function getCommands(cwd: string): Promise<Command[]> {
	...
	const globalDir = path.join(getGlobalAfxDirectory(), "commands")
	...
	const projectDir = path.join(getProjectAfxDirectoryForCwd(cwd), "commands")
