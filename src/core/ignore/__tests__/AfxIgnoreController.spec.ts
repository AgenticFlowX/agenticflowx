...
import { AfxIgnoreController, LOCK_TEXT_SYMBOL } from "../AfxIgnoreController"
...
describe("AfxIgnoreController", () => {
	...
	beforeEach(() => {
		...
		// Create controller
		controller = new AfxIgnoreController(TEST_CWD)
	})
	...
	describe("initialization", () => {
		...
		it("should load .afxignore patterns on initialization when file exists", async () => {
			...
			expect(mockFileExists).toHaveBeenCalledWith(path.join(TEST_CWD, ".afxignore"))
	...
	describe("validateAccess", () => {
		...
		it("should allow all access when no .afxignore content", async () => {
			...
			mockFileExists.mockResolvedValue(false)
			const emptyController = new AfxIgnoreController(TEST_CWD)
