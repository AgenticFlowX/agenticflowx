 ...
 *
 * @see docs/specs/vscode-agenticflowx-ide-providers/design.md#spec-aware-code-actions
 * @see docs/specs/vscode-agenticflowx-ide-providers/tasks.md#5-spec-aware-code-actions
 */
