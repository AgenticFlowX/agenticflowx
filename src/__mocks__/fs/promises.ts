...
type RuleFiles = {
	".afxrules-code": string
	".afxrules-ask": string
	".afxrules-architect": string
	".afxrules-test": string
	".afxrules-review": string
	".afxrules": string
}
...
const mockFs = {
	readFile: vi.fn().mockImplementation(async (filePath: string, _encoding?: string) => {
		...
		const ruleFiles: RuleFiles = {
			".afxrules-code": "# Code Mode Rules\n1. Code specific rule",
			".afxrules-ask": "# Ask Mode Rules\n1. Ask specific rule",
			".afxrules-architect": "# Architect Mode Rules\n1. Architect specific rule",
			".afxrules-test":
