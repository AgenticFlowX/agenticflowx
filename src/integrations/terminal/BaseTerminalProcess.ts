...
import type { AfxTerminalProcess, AfxTerminalProcessEvents, ExitCodeDetails } from "./types"

export abstract class BaseTerminalProcess extends EventEmitter<AfxTerminalProcessEvents> implements AfxTerminalProcess {
	...
	// of before sending request to AgenticFlowX.
