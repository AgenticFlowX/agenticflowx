...
import { AfxIgnoreController, createVscodeFileWatcher } from "@agenticflowx/ignore"
import { stat } from "fs/promises"
import * as path from "path"
import { generateNormalizedAbsolutePath, generateRelativeFilePath } from "../shared/get-relative-path"
import { getWorkspacePathForContext } from "@agenticflowx/utils"
...
import { TelemetryEventName } from "@agenticflowx/types"
...
export class DirectoryScanner implements IDirectoryScanner {
	 ...
	 * @param afxIgnoreController Optional AfxIgnoreController instance for filtering
	...
	public async scanDirectory(
		...
		// Initialize AfxIgnoreController if not provided
		const ignoreController = new AfxIgnoreController(directoryPath, createVscodeFileWatcher)

		await ignoreController.initialize()

		// Filter paths using .afxignore
