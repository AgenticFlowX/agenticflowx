...
export class CodeIndexManager {
	...
	private async _recreateServices(): Promise<void> {
		...
		// Create AfxIgnoreController instance
		const afxIgnoreController = new AfxIgnoreController(workspacePath, createVscodeFileWatcher)
		await afxIgnoreController.initialize()
