...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .afx/rules-code/AGENTS.md (relative to project root)
       - .afx/rules-debug/AGENTS.md (relative to project root)
       - .afx/rules-ask/AGENTS.md (relative to project root)
       - .afx/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .afxrules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .afx/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .afx folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .afx/rules-code/AGENTS.md (create .afx in project root, not system root!)
    - .afx/rules-debug/AGENTS.md (relative to project root)
    - .afx/rules-ask/AGENTS.md (relative to project root)
    - .afx/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .afx directory must be created in the current project/workspace root directory,
    ...
    ├── .afx/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .afx/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .afx/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .afx/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    - Locales in root are for extension, apps/webview/src/i18n for UI (two separate systems)
    \`\`\`
