...
export async function regexSearchFiles(
	...
	// Filter results using AfxIgnoreController if provided
	const filteredResults = afxIgnoreController
		? results.filter((result) => afxIgnoreController.validateAccess(result.file))
		: results
