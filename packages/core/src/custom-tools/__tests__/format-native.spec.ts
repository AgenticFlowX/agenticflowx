...
// pnpm --filter @agenticflowx/core test src/custom-tools/__tests__/format-native.spec.ts

import { type SerializedCustomToolDefinition, parametersSchema as z, defineCustomTool } from "@agenticflowx/types"
