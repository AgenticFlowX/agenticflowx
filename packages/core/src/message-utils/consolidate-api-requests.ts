...
/**
 * Consolidates API request start and finish messages in an array of AfxMessages.
 *
 ...
 * @returns A new array of AfxMessage objects with API requests consolidated.
 *
 * @example
 * const messages = [
 ...
 */
export function consolidateApiRequests(messages: AfxMessage[]): AfxMessage[] {
