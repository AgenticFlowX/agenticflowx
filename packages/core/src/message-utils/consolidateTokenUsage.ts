...
import type { TokenUsage, ToolUsage, ToolName, AfxMessage } from "@agenticflowx/types"
...
/**
 * Consolidates token usage metrics from an array of AfxMessages.
 *
 ...
 */
export function consolidateTokenUsage(messages: AfxMessage[]): TokenUsage {
