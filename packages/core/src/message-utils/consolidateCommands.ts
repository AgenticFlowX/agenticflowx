...
/**
 * Consolidates sequences of command and command_output messages in an array of AfxMessages.
 * Also consolidates sequences of use_mcp_server and mcp_server_response messages.
 *
 * This function processes an array of AfxMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of AfxMessage objects to process.
 * @returns A new array of AfxMessage objects with command and MCP sequences consolidated.
 *
 * @example
 ...
 */
export function consolidateCommands(messages: AfxMessage[]): AfxMessage[] {
	const consolidatedMessages = new Map<number, AfxMessage>()
