...
import type { ModelInfo, ProviderSettings, ReasoningEffortExtended } from "@agenticflowx/types"

import { shouldUseReasoningBudget, shouldUseReasoningEffort } from "@agenticflowx/types"
...
export type AfxReasoningParams = {
	enabled?: boolean
	effort?: ReasoningEffortExtended
}
...
export const getAfxReasoning = ({
	model,
	reasoningEffort,
	settings,
}: GetModelReasoningOptions): AfxReasoningParams | undefined => {
	...
	// For AFX models that support reasoning effort, absence of a selection should be
	...
	// For AFX, "minimal" is treated as "none" for effort-based reasoning – we omit
