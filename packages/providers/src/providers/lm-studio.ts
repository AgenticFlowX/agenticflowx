...
import { type ModelInfo, openAiModelInfoSaneDefaults, LMSTUDIO_DEFAULT_TEMPERATURE } from "@agenticflowx/types"

import type { ApiHandlerOptions } from "@agenticflowx/types"

import { NativeToolCallParser } from "@agenticflowx/plugin-api"
import { TagMatcher } from "@agenticflowx/utils"
...
import { getModelsFromCache } from "./fetchers/model-cache"
...
export class LmStudioHandler extends BaseProvider implements SingleCompletionHandler {
	...
	override async *createMessage(
		...
		try {
			...
			throw new Error(
				"Please check the LM Studio developer logs to debug what went wrong. You may need to load the model with a larger context length to work with AgenticFlowX's prompts.",
			)
		}
	}
