...
function NativeSelectOption({ className, ...props }: React.ComponentProps<"option">) {
  return (
    <option
      ...
      className={cn("cn-native-select-option", "bg-[Canvas] text-[CanvasText]", className)}
      {...props}
    />
  );
}
...
function NativeSelectOptGroup({ className, ...props }: React.ComponentProps<"optgroup">) {
  return (
    <optgroup
      ...
      className={cn("cn-native-select-optgroup", "bg-[Canvas] text-[CanvasText]", className)}
      {...props}
    />
  );
}
