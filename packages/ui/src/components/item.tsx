...
function ItemSeparator({ className, ...props }: React.ComponentProps<typeof Separator>) {
  return (
    <Separator
      ...
      className={cn("cn-item-separator", "my-2", className)}
      {...props}
    />
  );
}
...
function Item({
  ...
  return (
    <Comp
      ...
      data-size={size}
      className={cn("cn-item", itemVariants({ variant, size, className }))}
      {...props}
    />
  );
}
...
function ItemMedia({
  ...
  return (
    <div
      ...
      data-variant={variant}
      className={cn("cn-item-media", itemMediaVariants({ variant, className }))}
      {...props}
    />
  );
}
