...
import { useIsMobile } from "@afx/ui/hooks/use-mobile";
...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="cn-sidebar w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      className="cn-sidebar group peer hidden text-sidebar-foreground md:block"
      data-state={state}
    ...
    >
      ...
      >
        <div
          ...
          className="cn-sidebar-inner flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-none group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
...
function SidebarInput({ className, ...props }: React.ComponentProps<typeof Input>) {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn("cn-sidebar-input", "h-8 w-full bg-background shadow-none", className)}
      {...props}
    />
  );
}
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("cn-sidebar-header", "flex flex-col gap-2 p-2", className)}
      {...props}
    />
  );
}
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("cn-sidebar-footer", "flex flex-col gap-2 p-2", className)}
      {...props}
    />
  );
}
...
function SidebarGroupContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("cn-sidebar-group-content", "w-full text-xs", className)}
      {...props}
    />
  );
}
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("cn-sidebar-menu", "flex w-full min-w-0 flex-col gap-0", className)}
      {...props}
    />
  );
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("cn-sidebar-menu-item", "group/menu-item relative", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSubItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("cn-sidebar-menu-sub-item", "group/menu-sub-item relative", className)}
      {...props}
    />
  );
}
