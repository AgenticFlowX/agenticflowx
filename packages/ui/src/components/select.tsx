...
function SelectGroup({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Group>) {
  return (
    <SelectPrimitive.Group
      ...
      className={cn("cn-select-group", "scroll-my-1", className)}
      {...props}
    />
  );
}
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon
          ...
          className="cn-select-trigger-icon pointer-events-none size-4 text-muted-foreground"
        />
...
function SelectLabel({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Label>) {
  return (
    <SelectPrimitive.Label
      ...
      className={cn("cn-select-label", "px-2 py-2 text-xs text-muted-foreground", className)}
      {...props}
    />
  );
}
  ...
  return (
    ...
    >
      <span
        ...
        className="cn-select-item-indicator pointer-events-none absolute right-2 flex size-4 items-center justify-center"
      >
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="pointer-events-none" />
        </SelectPrimitive.ItemIndicator>
      </span>
      <SelectPrimitive.ItemText data-slot="select-item-text" className="cn-select-item-text">
        {children}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("cn-select-separator", "pointer-events-none -mx-1 h-px bg-border", className)}
      {...props}
    />
  );
}
