...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span
        className="cn-dropdown-menu-checkbox-item-indicator pointer-events-none absolute right-2 flex items-center justify-center"
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span
        className="cn-dropdown-menu-radio-item-indicator pointer-events-none absolute right-2 flex items-center justify-center"
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("cn-dropdown-menu-separator", "-mx-1 h-px bg-border", className)}
      {...props}
    />
  );
}
