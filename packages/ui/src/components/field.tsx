...
function Field({
  ...
  return (
    <div
      ...
      className={cn("cn-field", fieldVariants({ orientation }), className)}
      {...props}
    />
  );
}
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="cn-field-separator-content relative mx-auto block w-fit bg-background px-2 text-muted-foreground"
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("cn-field-error", "text-xs font-normal text-destructive", className)}
      {...props}
    >
      {content}
    </div>
