...
function DrawerTitle({ className, ...props }: React.ComponentProps<typeof DrawerPrimitive.Title>) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("cn-drawer-title", "text-sm font-medium text-foreground", className)}
      {...props}
    />
  );
}
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("cn-drawer-description", "text-xs/relaxed text-muted-foreground", className)}
      {...props}
    />
  );
}
