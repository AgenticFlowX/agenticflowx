...
import { afxMessageSchema } from "./message.js"
...
export const afxTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
...
export type AfxTelemetryEvent = z.infer<typeof afxTelemetryEventSchema>
...
/**
 * Error class for "AFX is having trouble" consecutive mistake scenarios.
