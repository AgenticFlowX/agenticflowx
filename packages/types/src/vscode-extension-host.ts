...
import type { GlobalSettings, AfxSettings } from "./global-settings.js"
import type { ProviderSettings, ProviderSettingsEntry } from "./provider-settings.js"
import type { HistoryItem } from "./history.js"
import type { ModeConfig, PromptComponent } from "./mode.js"
import type { TelemetrySetting } from "./telemetry.js"
import type { Experiments } from "./experiment.js"
import type { AfxMessage, QueuedMessage } from "./message.js"
import {
...
> & {
	...
	showAfxIgnoredFiles: boolean // Whether to show .afxignore'd files in listings
	 ...
	 * When present, the frontend should only apply afxMessages from a state push
...
export type AfxAskResponse = "yesButtonClicked" | "noButtonClicked" | "messageResponse" | "objectResponse"
...
export interface WebviewMessage {
	...
	useProviderSignup?: boolean // For afxCloudSignIn to use provider signup flow
	codeIndexSettings?: {
...
export interface AfxAskUseMcpServer {
	serverName: string
...
export interface AfxApiReqInfo {
	request?: string
	tokensIn?: number
	tokensOut?: number
	cacheWrites?: number
	cacheReads?: number
	cost?: number
	cancelReason?: AfxApiReqCancelReason
	streamingFailedMessage?: string
	apiProtocol?: "anthropic" | "openai"
}

export type AfxApiReqCancelReason = "streaming_failed" | "user_cancelled"
