...
import type { AfxEvents } from "./events.js"
...
export type AfxAPIEvents = AfxEvents

export interface AfxAPI extends EventEmitter<AfxAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): AfxSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: AfxSettings): Promise<void>
	/**
...
export interface AfxIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
