...
export const globalSettingsSchema = z.object({
	...
	showAfxIgnoredFiles: z.boolean().optional(),
	 ...
	 * Used by the worktree feature to open the AgenticFlowX sidebar in a new window.
	 */
...
export const afxSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type AfxSettings = GlobalSettings & ProviderSettings
...
export type GlobalState = Omit<AfxSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<AfxSettings>) => !isSecretStateKey(key),
) as Keys<GlobalState>[]
...
export const EVALS_SETTINGS: AfxSettings = {
