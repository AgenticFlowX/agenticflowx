...
const extensionTaskSchema = z.object({
	...
	taskAsk: afxMessageSchema.optional(),
...
export enum TaskBridgeEventName {
	Message = AfxEventName.Message,
	TaskModeSwitched = AfxEventName.TaskModeSwitched,
	TaskInteractive = AfxEventName.TaskInteractive,
}
