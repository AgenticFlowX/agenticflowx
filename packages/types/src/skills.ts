...
export interface SkillMetadata {
	...
	modeSlugs?: string[]
	/**
	 * [AFX] Hint text showing available subcommands.
	 * Displayed in the slash command dropdown next to the skill name.
	 * Parsed from SKILL.md frontmatter: metadata.afx-argument-hint
	 */
	argumentHint?: string
}
