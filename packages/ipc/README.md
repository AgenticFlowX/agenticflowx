...
This package provides IPC functionality for AgenticFlowX, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: AgenticFlowX settings object
...
- Unix/Linux/macOS: `/tmp/afx-{id}.sock`
- Windows: `\\.\pipe\afx-{id}`
