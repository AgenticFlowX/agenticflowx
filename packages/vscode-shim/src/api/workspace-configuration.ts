...
import type { ExtensionContextImpl } from "../context/extension-context.js"
 ...
 * @param section The configuration section (e.g., "agenticflowx")
 ...
 * @param fullKey The full configuration key (e.g., "agenticflowx.commandExecutionTimeout")
