...
describe("ContextManagementSettings", () => {
	...
	it("renders other context management settings", () => {
		...
		expect(screen.getByTestId("show-afxignored-files-checkbox")).toBeInTheDocument()
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.afxignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.afxignore.description")).toBeInTheDocument()
		})
