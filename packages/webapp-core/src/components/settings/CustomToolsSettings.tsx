...
import type { SerializedCustomToolDefinition } from "@agenticflowx/types"
				...
				<div className="ml-2 space-y-3">
					<div className="flex items-center justify-between gap-4">
						...
						<Button variant="outline" onClick={onRefresh} disabled={isRefreshing}>
							<div className="flex items-center gap-2">
								{isRefreshing ? (
									<span className="codicon codicon-loading codicon-modifier-spin w-4 h-4" />
								) : (
									<span className="codicon codicon-refresh w-4 h-4" />
								)}
								{isRefreshing
								...
								<div className="space-y-1">
									...
									{tool.source && (
										<div className="flex items-center text-xs text-vscode-descriptionForeground">
											<span className="codicon codicon-file-code size-3 flex-shrink-0" />
