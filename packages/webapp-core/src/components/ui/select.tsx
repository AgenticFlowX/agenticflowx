	...
	return (
		<SelectPrimitive.Trigger
			...
			<SelectPrimitive.Icon asChild>
				<span className="codicon codicon-chevron-down size-4 opacity-50" />
		...
		<SelectPrimitive.Item
			...
			<span className="absolute right-2 flex size-3.5 items-center justify-center">
				<SelectPrimitive.ItemIndicator>
					<span className="codicon codicon-check size-4 p-0.5" />
				</SelectPrimitive.ItemIndicator>
			</span>
...
function SelectScrollUpButton({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.ScrollUpButton>) {
	return (
		<SelectPrimitive.ScrollUpButton
			...
			{...props}>
			<span className="codicon codicon-chevron-up size-4" />
		</SelectPrimitive.ScrollUpButton>
	)
}
...
function SelectScrollDownButton({
	...
	return (
		<SelectPrimitive.ScrollDownButton
			...
			className={cn("flex cursor-default items-center justify-center py-1", className)}
			{...props}>
			<span className="codicon codicon-chevron-down size-4" />
		</SelectPrimitive.ScrollDownButton>
	)
}
