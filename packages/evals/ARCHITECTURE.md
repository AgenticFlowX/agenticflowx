...
- **Environment Setup**: Launches VS Code with AgenticFlowX extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and AgenticFlowX extension
