...
This guide explains how to add new coding exercises to the AgenticFlowX evals system. The evals system is a distributed evaluation platform that runs AI coding tasks in isolated VS Code environments to test AI coding capabilities across multiple programming languages.
...
- **Exercises Repository**: [`agenticflowx-evals`](https://github.com/AgenticFlowX/agenticflowx-evals) - Contains all exercise definitions
...
TL;DR - Here's a pull request that adds a new JavaScript eval: https://github.com/AgenticFlowX/agenticflowx-evals/pull/3
...
1. **Clone the evals repository**:
    ...
    ```bash
    git clone https://github.com/AgenticFlowX/agenticflowx-evals.git evals
    cd evals
    ```
...
version = "0.1.0"
description = "Python exercises for AgenticFlowX evals"
requires-python = ">=3.9"
dependencies = [
    "pytest>=8.3.5",
]
...
Adding a new programming language requires changes to both the evals repository and the main AgenticFlowX repository.
