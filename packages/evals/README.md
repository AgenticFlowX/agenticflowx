...
By default an evals run will run all programming exercises in the [AgenticFlowX Evals](https://github.com/AgenticFlowX/agenticflowx) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import an AgenticFlowX settings file which will allow you to run the evals with AgenticFlowX configured any way you'd like (this includes custom modes, custom instructions, etc).
...
- Optionally builds and installs the AgenticFlowX extension from source
