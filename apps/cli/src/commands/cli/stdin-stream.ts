...
import {
	afxCliCommandNames,
	type AfxCliCommandName,
	type AfxCliInputCommand,
	type AfxCliStartCommand,
...
export type StdinStreamCommandName = AfxCliCommandName

export type StdinStreamCommand = AfxCliInputCommand

// ---------------------------------------------------------------------------
// Parsing
// ---------------------------------------------------------------------------

export const VALID_STDIN_COMMANDS = new Set<StdinStreamCommandName>(afxCliCommandNames)
		...
		if (command === "start") {
			...
			if (isRecord(parsed.configuration)) {
				return {
					...
					configuration: parsed.configuration as AfxCliStartCommand["configuration"],
				}
			}
