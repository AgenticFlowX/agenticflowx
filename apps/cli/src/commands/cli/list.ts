...
import type { TaskSessionEntry } from "@agenticflowx/core/cli"
import type { Command, ModelRecord, WebviewMessage } from "@agenticflowx/types"
import { getProviderDefaultModelId } from "@agenticflowx/types"
...
export async function listModels(options: BaseListOptions): Promise<void> {
	...
	await withHostAndSignalHandlers(options, { ephemeral: true }, async (_host) => {
		// TODO: Implement model listing for all providers
