 ...
 * - The afxMessages array (source of truth for agent state)
...
import { AfxMessage, ExtensionState } from "@agenticflowx/types"
...
export class StateStore {
	 ...
	 */
	getLastMessage(): AfxMessage | undefined {
	 ...
	 */
	setMessages(messages: AfxMessage[]): AgentStateInfo {
	 ...
	 */
	addMessage(message: AfxMessage): AgentStateInfo {
	 ...
	 */
	updateMessage(message: AfxMessage): AgentStateInfo | undefined {
	...
	setExtensionState(extensionState: Partial<ExtensionState>): void {
		...
		if (extensionState.afxMessages) {
			this.setMessages(extensionState.afxMessages)
		}
