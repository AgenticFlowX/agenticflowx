...
import type { ExtensionMessage, WebviewMessage, AfxAskResponse, AfxMessage, AfxAsk } from "@agenticflowx/types"
...
/**
 * ExtensionClient is the main interface for interacting with the AgenticFlowX extension.
 *
 * Basic usage:
 * ```typescript
...
export class ExtensionClient {
	 ...
	 */
	getCurrentAsk(): AfxAsk | undefined {
	 ...
	 */
	sendResponse(response: AfxAskResponse, text?: string, images?: string[]): void {
