...
/**
 * Theme configuration for AgenticFlowX CLI TUI
...
export const afxHeader = hardcore.yellow // Yellow for afx
...
export const afxText = hardcore.text // Standard text for afx
