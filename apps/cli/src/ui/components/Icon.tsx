 ...
 *
 * Users can override this with the AFX_NERD_FONT environment variable:
 * - AFX_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - AFX_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.AFX_NERD_FONT
	...
	// and users can set AFX_NERD_FONT=0 if needed
	return true
}
