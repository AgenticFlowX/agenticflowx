...
import { readTaskSessionsFromStoragePath } from "@agenticflowx/core/cli"
...
vi.mock("@agenticflowx/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@agenticflowx/core/cli")>()
	return {
		...actual,
