...
async function main() {
	const cliRoot = process.env.AFX_CLI_ROOT
		? path.resolve(process.env.AFX_CLI_ROOT)
		: path.resolve(__dirname, "../../..")
	const workspacePath = await fs.mkdtemp(path.join(os.tmpdir(), "afx-cli-create-session-id-"))
