...
import { resolveSkillContentForMode, buildSkillApprovalMessage, buildSkillResult } from "../skill-invocation"
import type { SkillLookup } from "../skill-invocation"
...
describe("skillInvocation", () => {
	const mockSkillContent: SkillContent = {
		...
		path: "/mock/.afx/skills/test-skill/SKILL.md",
		source: "project",
