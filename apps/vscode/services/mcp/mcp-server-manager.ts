...
export class McpServerManager {
	...
	private static providers: Set<ITaskProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: ITaskProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: ITaskProvider): void {
