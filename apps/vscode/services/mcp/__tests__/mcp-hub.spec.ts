...
import type { McpHub as McpHubType, McpConnection, ConnectedMcpConnection, DisconnectedMcpConnection } from "../mcp-hub"
import { ServerConfigSchema, McpHub } from "../mcp-hub"
...
vi.mock("fs/promises")
vi.mock("../../../core/webview/i-task-provider")
...
describe("McpHub", () => {
	...
	beforeEach(() => {
		...
		mcpHub = new McpHub(mockProvider as ITaskProvider)
	})
	...
	describe("Discriminated union type handling", () => {
		it("should create connected connections with proper type", async () => {
			...
			const mcpHub = new McpHub(mockProvider as ITaskProvider)
	...
	describe("MCP global enable/disable", () => {
		...
		it("should not connect to servers when MCP is globally disabled", async () => {
			...
			const mcpHub = new McpHub(disabledMockProvider as unknown as ITaskProvider)
		...
		it("should connect to servers when MCP is globally enabled", async () => {
			...
			const mcpHub = new McpHub(enabledMockProvider as unknown as ITaskProvider)
