...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: AfxIgnoreController
	...
	constructor(
		...
		ignoreController?: AfxIgnoreController,
		batchSegmentThreshold?: number,
	) {
		this.ignoreController = ignoreController || new AfxIgnoreController(workspacePath, createVscodeFileWatcher)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .afxignore or .gitignore",
				}
			}
