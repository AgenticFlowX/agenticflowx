...
vi.mock("fs/promises")
vi.mock("../afx-config", () => ({
	getGlobalAfxDirectory: vi.fn(() => "/mock/global/.afx"),
	getProjectAfxDirectoryForCwd: vi.fn(() => "/mock/project/.afx"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".afx", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".afx", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
				mode: undefined,
			})
	...
	describe("argument-hint functionality", () => {
		it("should load command with argument-hint from frontmatter", async () => {
			const commandContent = `---
description: Create a new release of the AgenticFlowX extension
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".afx", "commands", "release.md"),
				description: "Create a new release of the AgenticFlowX extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".afx", "commands", "deploy.md"),
				description: "Deploy application to environment",
...
Start debugging.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".afx", "commands", "debug-app.md"),
				description: "Debug the application",
				argumentHint: undefined,
				mode: "debug",
			})
