...
import type { AfxTerminal } from "./types"
import { BaseTerminal } from "./base-terminal"
import { BaseTerminalProcess } from "./base-terminal-process"

export class ExecaTerminalProcess extends BaseTerminalProcess {
	private terminalRef: WeakRef<AfxTerminal>
	private aborted = false
	private pid?: number
	private subprocess?: ReturnType<typeof execa>
	private pidUpdatePromise?: Promise<void>

	constructor(terminal: AfxTerminal) {
		super()
	...
	public get terminal(): AfxTerminal {
