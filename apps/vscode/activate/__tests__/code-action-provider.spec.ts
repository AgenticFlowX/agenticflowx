...
import { CodeActionProvider, TITLES } from "../code-action-provider"
...
vi.mock("../../integrations/editor/editor-utils", () => ({
	EditorUtils: {
...
describe("CodeActionProvider", () => {
	...
	describe("provideCodeActions", () => {
		...
		it("should return empty array when enableCodeActions is disabled", () => {
			...
			expect(actions).toEqual([])
			expect(vscode.workspace.getConfiguration).toHaveBeenCalledWith("agenticflowx")
