...
import { CodeActionName, CodeActionId } from "@agenticflowx/types"
import { Package } from "../shared/package"

import { getCodeActionCommand } from "../utils/commands"
import { EditorUtils } from "../integrations/editor/editor-utils"

export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with AgenticFlowX",
	FIX: "Fix with AgenticFlowX",
	IMPROVE: "Improve with AgenticFlowX",
	ADD_TO_CONTEXT: "Add to AgenticFlowX",
	NEW_TASK: "New AgenticFlowX Task",
} as const
