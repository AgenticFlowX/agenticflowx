...
// pnpm --filter agenticflowx test api/providers/__tests__/openrouter.spec.ts
...
vitest.mock("@agenticflowx/telemetry", () => ({
	TelemetryService: {
		instance: {
...
vitest.mock("../fetchers/model-cache", () => ({
...
describe("OpenRouterHandler", () => {
	...
	describe("createMessage", () => {
		...
		it("yields tool_call_end events when finish_reason is tool_calls", async () => {
			...
			const { NativeToolCallParser } = await import("../../../core/assistant-message/native-tool-call-parser")
