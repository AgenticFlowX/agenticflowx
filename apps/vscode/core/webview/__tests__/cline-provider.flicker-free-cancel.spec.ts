...
import type { ProviderSettings, HistoryItem } from "@agenticflowx/types"
...
vi.mock("../../config/provider-settings-manager")
vi.mock("../../config/custom-modes-manager")
vi.mock("../../../utils/path", () => ({
...
vi.mock("../../../shared/embedding-models", () => ({
	EMBEDDING_MODEL_PROFILES: [],
}))

describe("AfxProvider flicker-free cancel", () => {
	...
	beforeEach(() => {
		...
		provider = new AfxProvider(mockContext, mockOutputChannel, "sidebar", mockContextProxy as any)
