...
import type { SkillMetadata, WebviewMessage } from "@agenticflowx/types"
...
describe("skillsMessageHandler", () => {
	...
	const createMockProvider = (hasSkillsManager: boolean = true): AfxProvider => {
	...
	const mockSkills: SkillMetadata[] = [
		...
		},
		{
			...
			path: "/project/.afx/skills/project-skill/SKILL.md",
			source: "project",
			mode: "code",
		},
	]
	...
	describe("handleOpenSkillFile", () => {
		...
		it("opens a skill file with mode restriction", async () => {
			...
			expect(openFile).toHaveBeenCalledWith("/project/.afx/skills/project-skill/SKILL.md")
		})
