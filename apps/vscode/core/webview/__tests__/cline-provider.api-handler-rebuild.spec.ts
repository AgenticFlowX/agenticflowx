...
// npx vitest core/webview/__tests__/AfxProvider.apiHandlerRebuild.spec.ts

import * as vscode from "vscode"

import { TelemetryService } from "@agenticflowx/telemetry"
import { getModelId } from "@agenticflowx/types"
...
describe("AfxProvider - API Handler Rebuild Guard", () => {
