...
// pnpm --filter agenticflowx test core/webview/__tests__/AfxProvider.taskHistory.spec.ts

import * as vscode from "vscode"
import type { HistoryItem, ExtensionMessage } from "@agenticflowx/types"
...
describe("AfxProvider Task History Synchronization", () => {
	...
	describe("taskHistory write lock (mutex)", () => {
		...
		it("does not block subsequent writes when a previous store write errors", async () => {
			...
			const { safeWriteJson } = await import("../../../utils/safe-write-json")
