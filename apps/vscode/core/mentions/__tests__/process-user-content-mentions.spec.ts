...
import { processUserContentMentions } from "../process-user-content-mentions"
...
describe("processUserContentMentions", () => {
	...
	let mockAfxIgnoreController: any

	beforeEach(() => {
		vi.clearAllMocks()

		mockFileContextTracker = {} as FileContextTracker
		mockAfxIgnoreController = {}
	...
	describe("showAfxIgnoredFiles parameter", () => {
		it("should default showAfxIgnoredFiles to false", async () => {
			const userContent = [
				{
					type: "text" as const,
			...
			expect(parseMentions).toHaveBeenCalledWith(
				...
				undefined,
				false, // showAfxIgnoredFiles should default to false
		...
		it("should respect showAfxIgnoredFiles when explicitly set to false", async () => {
			const userContent = [
				{
					type: "text" as const,
