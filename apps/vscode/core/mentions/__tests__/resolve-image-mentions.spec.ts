...
import { resolveImageMentions } from "../resolve-image-mentions"

vi.mock("../../tools/helpers/image-helpers", () => ({
...
import { validateImageForProcessing, readImageAsDataUrlWithBuffer } from "../../tools/helpers/image-helpers"
...
describe("resolveImageMentions", () => {
	...
	it("should respect afxIgnoreController", async () => {
		...
		expect(afxIgnoreController.validateAccess).toHaveBeenCalledWith("secret.jpg")
		expect(mockReadImageAsDataUrl).not.toHaveBeenCalled()
		expect(result.images).toEqual([])
	})
