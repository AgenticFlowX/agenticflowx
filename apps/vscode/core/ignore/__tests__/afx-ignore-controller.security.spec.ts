...
// npx vitest core/ignore/__tests__/AfxIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { AfxIgnoreController } from "../afx-ignore-controller"
...
describe("AfxIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .afxignore to exist with some patterns
