...
import { GLOBAL_STATE_KEYS, SECRET_STATE_KEYS, GLOBAL_SECRET_KEYS } from "@agenticflowx/types"
...
describe("ContextProxy", () => {
	...
	describe("getGlobalState", () => {
		it("should return value from cache when it exists", async () => {
			...
			// Original context should be called during initialization (+2 for migration checks)
