...
describe("editFileTool", () => {
	...
	beforeEach(() => {
		...
		mockTask.afxIgnoreController = {
			validateAccess: vi.fn().mockReturnValue(true),
		}
		mockTask.afxProtectedController = {
	...
	async function executeEditFileTool(
		...
		mockTask.afxIgnoreController.validateAccess.mockReturnValue(accessAllowed)
	...
	describe("parameter validation", () => {
		...
		describe("native tool mode coercion", () => {
			...
			async function executeWithNativeArgs(
				...
				mockedFileExistsAtPath.mockResolvedValue(fileExists)
				mockedFsReadFile.mockResolvedValue(fileContent)
				mockTask.afxIgnoreController.validateAccess.mockReturnValue(true)
	...
	describe("file tracking", () => {
		it("tracks file context after successful edit", async () => {
			...
			expect(mockTask.fileContextTracker.trackFileContext).toHaveBeenCalledWith(testFilePath, "afx_edited")
		})
	})
