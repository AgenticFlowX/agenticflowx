...
import { runSlashCommandTool } from "../run-slash-command-tool"
...
Use skill workflow`,
	...
	it("should preserve command precedence over skill fallback", async () => {
		...
		const mockCommand = {
			...
			source: "project" as const,
			filePath: ".afx/commands/setup.md",
...
Run tests with specific focus`,
	...
	it("should handle global command", async () => {
		...
		const mockCommand = {
			...
			filePath: "~/.afx/commands/deploy.md",
		}
...
Deploy application to production`,
	...
	it("should switch mode when mode is specified in command", async () => {
		...
		const mockCommand = {
			...
			source: "project" as const,
			filePath: ".afx/commands/debug-app.md",
