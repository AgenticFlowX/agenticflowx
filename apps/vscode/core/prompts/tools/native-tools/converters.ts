...
//
// Canonical copy lives in @agenticflowx/plugin-api.
// This local copy remains for SDK type compatibility within apps/vscode/.
// When providers are extracted (Phase 2), they'll import from plugin-api directly.
