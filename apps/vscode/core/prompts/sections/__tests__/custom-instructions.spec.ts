...
describe("loadRuleFiles", () => {
	...
	it("should read and trim file content", async () => {
		// Simulate no .afx/rules directory
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".afxrules")) {
				return Promise.resolve("afx rules content")
			}
	...
	it("should use .afx/rules/ directory when it exists and has files", async () => {
		// Simulate .afx/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{ name: "file2.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.afx/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.afx/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.afx/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.afx/rules/file2.txt") {
		...
		const expectedRelativePath1 = process.platform === "win32" ? ".afx\\rules\\file1.txt" : ".afx/rules/file1.txt"
		const expectedRelativePath2 = process.platform === "win32" ? ".afx\\rules\\file2.txt" : ".afx/rules/file2.txt"
		...
		const expectedRulesDir = process.platform === "win32" ? "\\fake\\path\\.afx\\rules" : "/fake/path/.afx/rules"
		const expectedFile1Path =
			process.platform === "win32" ? "\\fake\\path\\.afx\\rules\\file1.txt" : "/fake/path/.afx/rules/file1.txt"
		const expectedFile2Path =
			process.platform === "win32" ? "\\fake\\path\\.afx\\rules\\file2.txt" : "/fake/path/.afx/rules/file2.txt"
	...
	it("should filter out cache files from .afx/rules/ directory", async () => {
		// Simulate .afx/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{ name: ".DS_Store", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{ name: "Thumbs.db", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{ name: "rule2.md", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{ name: "cache.log", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{
				name: "backup.bak",
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.afx/rules",
			},
			{ name: "temp.tmp", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.afx/rules" },
			{
				name: "script.pyc",
				isFile: () => true,
				isSymbolicLink: () => false,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.afx/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.afx/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.afx/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.afx/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.afx/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.afx/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.afx/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.afx/rules/.DS_Store",
			"/fake/path/.afx/rules/Thumbs.db",
			"/fake/path/.afx/rules/backup.bak",
			"/fake/path/.afx/rules/cache.log",
			"/fake/path/.afx/rules/temp.tmp",
			"/fake/path/.afx/rules/script.pyc",
		]
	...
	it("should fall back to .afxrules when .afx/rules/ is empty", async () => {
		// Simulate .afx/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .afx/rules/", async () => {
		// Simulate .afx/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.afx/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.afx/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.afx/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRelativeRootPath = process.platform === "win32" ? ".afx\\rules\\root.txt" : ".afx/rules/root.txt"
		const expectedRelativeNested1Path =
			process.platform === "win32" ? ".afx\\rules\\subdir\\nested1.txt" : ".afx/rules/subdir/nested1.txt"
		const expectedRelativeNested2Path =
			process.platform === "win32"
				? ".afx\\rules\\subdir\\subdir2\\nested2.txt"
				: ".afx/rules/subdir/subdir2/nested2.txt"
		...
		const expectedRootPath2 =
			process.platform === "win32" ? "\\fake\\path\\.afx\\rules\\root.txt" : "/fake/path/.afx/rules/root.txt"
		const expectedNested1Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.afx\\rules\\subdir\\nested1.txt"
				: "/fake/path/.afx/rules/subdir/nested1.txt"
		const expectedNested2Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.afx\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.afx/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .afx/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		expect(result).toContain("Rules from .afxrules-test-mode:\nmode specific rules")
	})
	...
	it("should include AGENTS.md content along with other rules", async () => {
		...
		// Should contain both AGENTS.md and .afxrules content
		expect(result).toContain("# Agent Rules Standard (AGENTS.md):")
		expect(result).toContain("Agent rules content")
		expect(result).toContain("# Rules from .afxrules:")
		expect(result).toContain("AFX rules content")
	})
	...
	it("should handle missing mode-specific rules file", async () => {
		...
		expect(result).toContain("Global Instructions:")
		expect(result).toContain("Mode-specific Instructions:")
		expect(result).not.toContain("Rules from .afxrules-test-mode")
	})
	...
	it("should skip mode-specific rule files that are directories", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".afxrules-test-mode")) {
				return Promise.reject({ code: "EISDIR" })
			}
			return Promise.reject({ code: "ENOENT" })
		})
	...
	it("should use .afx/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .afx/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.afx/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.afx/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.afx/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.afx/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.afx/rules-test-mode/rule2.txt") {
		...
		const expectedRelativeRule1Path =
			process.platform === "win32" ? ".afx\\rules-test-mode\\rule1.txt" : ".afx/rules-test-mode/rule1.txt"
		const expectedRelativeRule2Path =
			process.platform === "win32" ? ".afx\\rules-test-mode\\rule2.txt" : ".afx/rules-test-mode/rule2.txt"
		...
		const expectedAbsTestModeDir =
			process.platform === "win32" ? "\\fake\\path\\.afx\\rules-test-mode" : "/fake/path/.afx/rules-test-mode"
		const expectedAbsRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.afx\\rules-test-mode\\rule1.txt"
				: "/fake/path/.afx/rules-test-mode/rule1.txt"
		const expectedAbsRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.afx\\rules-test-mode\\rule2.txt"
				: "/fake/path/.afx/rules-test-mode/rule2.txt"
	...
	it("should fall back to .afxrules-test-mode when .afx/rules-test-mode/ does not exist", async () => {
		// Simulate .afx/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .afxrules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".afxrules-test-mode")) {
	...
	it("should correctly format content from directories when using .afx/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
		...
		readdirMock
			...
			.mockResolvedValueOnce([
				{ name: "subdir_link.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules/symlink-target-dir" },
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.afx/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.afx/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.afx/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.afx/nested-symlink-target.txt") {
		...
		const expectedRelativeRegularPath =
			process.platform === "win32" ? ".afx\\rules\\regular.txt" : ".afx/rules/regular.txt"
		const expectedRelativeSymlinkPath =
			process.platform === "win32" ? ".afx\\symlink-target.txt" : ".afx/symlink-target.txt"
		const expectedRelativeSubdirPath =
			process.platform === "win32"
				? ".afx\\rules\\symlink-target-dir\\subdir_link.txt"
				: ".afx/rules/symlink-target-dir/subdir_link.txt"
		const expectedRelativeNestedPath =
			process.platform === "win32" ? ".afx\\nested-symlink-target.txt" : ".afx/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.afx/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.afx/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.afx/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.afx/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.afx/rules/symlink-target-dir/subdir_link.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.afx/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			expect([
				"/fake/path/.afx/rules/file1.txt",
				"/fake/path/.afx/rules/file2.txt",
				"/fake/path/.afx/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.afx/rules/file3.txt") {
		...
		const expectedRelativeFile1Path =
			process.platform === "win32" ? ".afx\\rules\\file1.txt" : ".afx/rules/file1.txt"
		const expectedRelativeFile2Path =
			process.platform === "win32" ? ".afx\\rules\\file2.txt" : ".afx/rules/file2.txt"
		const expectedRelativeFile3Path =
			process.platform === "win32" ? ".afx\\rules\\file3.txt" : ".afx/rules/file3.txt"
	...
	it("should return files in alphabetical order by filename", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "zebra.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" },
			{ name: "alpha.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" },
			{ name: "Beta.txt", isFile: () => true, parentPath: "/fake/path/.afx/rules" }, // Test case-insensitive sorting
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			const pathStr = filePath.toString()
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.afx/rules/zebra.txt") {
				return Promise.resolve("zebra content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/alpha.txt") {
				return Promise.resolve("alpha content")
			}
			if (normalizedPath === "/fake/path/.afx/rules/Beta.txt") {
		...
		const expectedRelativeAlphaPath =
			process.platform === "win32" ? ".afx\\rules\\alpha.txt" : ".afx/rules/alpha.txt"
		const expectedRelativeBetaPath = process.platform === "win32" ? ".afx\\rules\\Beta.txt" : ".afx/rules/Beta.txt"
		const expectedRelativeZebraPath =
			process.platform === "win32" ? ".afx\\rules\\zebra.txt" : ".afx/rules/zebra.txt"
	...
	it("should sort symlinks by their symlink names, not target names", async () => {
		...
		// First call: check if .afx/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
