...
import type { GlobalState, ProviderSettings, ModelInfo } from "@agenticflowx/types"
...
describe("Queued message processing after condense", () => {
	function createProvider(): any {
		...
		const provider = new AfxProvider(ctx, output as any, "sidebar", new ContextProxy(ctx)) as any
