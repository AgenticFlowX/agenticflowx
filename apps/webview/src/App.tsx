...
import type { ExtensionMessage } from "@agenticflowx/types"

import TranslationProvider from "./i18n/TranslationContext"
import { MarketplaceViewStateManager } from "./components/marketplace/marketplace-view-state-manager"

import { vscode } from "./utils/vscode"
import { initializeSourceMaps, exposeSourceMapsForDebugging } from "./utils/source-map-initializer"
...
import { useAddNonInteractiveClickListener } from "./components/ui/hooks/use-non-interactive-click"
...
const App = () => {
	const { didHydrateState, showWelcome, shouldShowAnnouncement, renderContext, mdmCompliant } = useExtensionState()
