...
import { enhanceErrorWithSourceMaps } from "@src/utils/source-map-utils"
		...
		return (
			<div>
				...
				<p className="mb-4">
					...
					<a href="https://github.com/agenticflowx/agenticflowx/issues" target="_blank" rel="noreferrer">
