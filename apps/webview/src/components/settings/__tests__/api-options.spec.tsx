...
import { type ModelInfo, type ProviderSettings, openAiModelInfoSaneDefaults } from "@agenticflowx/types"
import { openAiCodexDefaultModelId } from "@agenticflowx/types"
...
// Mock AFX provider for tests

// Mock AFXBalanceDisplay for tests
vi.mock("../providers/RooBalanceDisplay", () => ({
	RooBalanceDisplay: () => <div data-testid="afx-balance-display">Balance: $10.00</div>,
}))
