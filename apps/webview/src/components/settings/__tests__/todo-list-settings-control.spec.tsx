		...
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"settings:advanced.todoList.description":
					"When enabled, AFX can create and manage todo lists to track task progress. This helps organize complex tasks into manageable steps.",
			}
...
describe("TodoListSettingsControl", () => {
	it("renders with default props", () => {
		...
		const description = screen.getByText(/When enabled, AFX can create and manage todo lists/)
