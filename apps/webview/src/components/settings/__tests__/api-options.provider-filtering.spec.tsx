...
import type { ProviderSettings, OrganizationAllowList } from "@agenticflowx/types"
...
vi.mock("@src/components/ui/hooks/use-router-models", () => ({
	useRouterModels: () => ({
		data: null,
		refetch: vi.fn(),
	}),
...
vi.mock("@src/components/ui/hooks/use-open-router-model-providers", () => ({
