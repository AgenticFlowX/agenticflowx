...
// pnpm --filter @agenticflowx/vscode-webview test src/components/settings/__tests__/SettingsView.spec.tsx
...
describe("SettingsView - Allowed Commands", () => {
	...
	describe("SettingsView - Tab Navigation", () => {
		...
		it("shows unsaved changes dialog when clicking Done with unsaved changes", () => {
			...
			// Activate the checkpoints tab
			activateTab("checkpoints")

			const content = getSettingsContent()
			// Make a change to create unsaved changes
			const timeoutSlider = within(content).getByTestId("checkpoint-timeout-slider")
