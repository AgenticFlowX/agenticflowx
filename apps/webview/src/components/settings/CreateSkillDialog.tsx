...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@agenticflowx/types"
...
/**
 * Validate skill name using shared validation from @agenticflowx/types.
