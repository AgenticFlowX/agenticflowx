...
} from "./utils/provider-model-config"

import { vscode } from "@src/utils/vscode"
import { validateApiConfigurationExcludingModelErrors, getModelValidationError } from "@src/utils/validate"
import { useAppTranslation } from "@src/i18n/TranslationContext"
import { useRouterModels } from "@src/components/ui/hooks/use-router-models"
import { useSelectedModel } from "@src/components/ui/hooks/use-selected-model"
import { useExtensionState } from "@src/context/ExtensionStateContext"
import {
	useOpenRouterModelProviders,
	OPENROUTER_DEFAULT_PROVIDER_NAME,
} from "@src/components/ui/hooks/use-open-router-model-providers"
import { filterProviders, filterModels } from "./utils/organization-filters"
import {
	Select,
	SelectTrigger,
	SelectValue,
				...
				<div className="flex justify-between items-center">
					...
					{docs && (
						<VSCodeLink href={docs.url} target="_blank" className="flex gap-2">
							...
							<span className="codicon codicon-book size-4 inline ml-2" />
						</VSCodeLink>
					)}
				</div>
				<SearchableSelect
