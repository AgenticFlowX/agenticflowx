...
import { filterModels } from "./utils/organization-filters"
		...
		<>
				...
				<Popover open={open} onOpenChange={onOpenChange}>
					<PopoverTrigger asChild>
						<Button
							...
							<span className="codicon codicon-unfold opacity-50" />
						</Button>
					</PopoverTrigger>
								...
								<CommandGroup>
									{modelIds.map((model) => (
										<CommandItem
											...
											<span
												className={cn(
													"codicon codicon-check size-4 p-0.5 ml-auto",
			...
			{simplifySettings ? (
				<p className="text-xs text-vscode-descriptionForeground m-0">
					<span className="codicon codicon-info size-3 inline mr-1" />
