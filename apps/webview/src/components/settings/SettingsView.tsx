...
import { useSearchIndexRegistry, SearchIndexProvider } from "./use-settings-search"
...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
		...
		if (isSettingValid) {
			vscode.postMessage({
				...
				updatedSettings: {
					...
					showAfxIgnoredFiles: showAfxIgnoredFiles ?? true,
	...
	const sections: { id: SectionName; iconClass: string }[] = useMemo(
		() => [
			{ id: "providers", iconClass: "codicon-plug" },
			{ id: "modes", iconClass: "codicon-organization" },
			{ id: "skills", iconClass: "codicon-mortar-board" },
			{ id: "slashCommands", iconClass: "codicon-terminal" },
			{ id: "autoApprove", iconClass: "codicon-check-all" },
			{ id: "mcp", iconClass: "codicon-server" },
			{ id: "checkpoints", iconClass: "codicon-git-commit" },
			{ id: "contextManagement", iconClass: "codicon-database" },
			{ id: "terminal", iconClass: "codicon-terminal" },
			{ id: "prompts", iconClass: "codicon-comment" },
			{ id: "worktrees", iconClass: "codicon-git-branch" },
			{ id: "ui", iconClass: "codicon-settings-gear" },
			{ id: "experimental", iconClass: "codicon-beaker" },
			{ id: "language", iconClass: "codicon-globe" },
			{ id: "about", iconClass: "codicon-info" },
		],
		...
		<Tab>
						...
						const triggerComponent = (
							<TabTrigger
								...
								<div className={cn("flex items-center gap-2", isCompactMode && "justify-center")}>
									<span className={`codicon ${iconClass} w-4 h-4`} />
					...
					<SearchIndexProvider value={searchContextValue}>
						...
						{renderTab === "contextManagement" && (
							<ContextManagementSettings
								...
								showAfxIgnoredFiles={showAfxIgnoredFiles}
			...
			<AlertDialog open={isDiscardDialogShow} onOpenChange={setDiscardDialogShow}>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>
							<span className="codicon codicon-warning w-5 h-5 text-yellow-500" />
