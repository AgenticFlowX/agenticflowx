...
import { MarketplaceViewStateManager } from "./marketplace-view-state-manager"
							...
							<Popover open={isTagPopoverOpen} onOpenChange={(open) => setIsTagPopoverOpen(open)}>
								<PopoverTrigger asChild>
									<Button
										...
										<span className="codicon codicon-unfold ml-2 h-4 w-4 shrink-0 opacity-50" />
									</Button>
								</PopoverTrigger>
								<PopoverContent
										...
										<div className="relative">
											...
											{tagSearch && (
												<Button
													...
													<span className="codicon codicon-close h-4 w-4" />
												</Button>
											)}
										</div>
