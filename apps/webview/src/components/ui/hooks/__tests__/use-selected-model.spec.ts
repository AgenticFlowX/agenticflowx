...
import { useRouterModels } from "../use-router-models"
import { useOpenRouterModelProviders } from "../use-open-router-model-providers"

vi.mock("../use-router-models")
vi.mock("../use-open-router-model-providers")
