		...
		<Popover open={open} onOpenChange={handleOpenChange}>
			<PopoverTrigger asChild>
				<Button
					...
					<span className="codicon codicon-chevron-down ml-2 h-4 w-4 shrink-0 opacity-50" />
				</Button>
			</PopoverTrigger>
					...
					<div className="relative">
						...
						{searchValue.length > 0 && (
							<div
								...
								<span className="codicon codicon-close text-vscode-input-foreground opacity-50 hover:opacity-100 size-4 p-0.5 cursor-pointer" />
							</div>
						)}
					</div>
					<CommandList>
						...
						<CommandGroup>
							{filteredOptions.map((option) => (
								<CommandItem
									...
									<span
										className={cn(
											"codicon codicon-check ml-auto h-4 w-4 p-0.5",
