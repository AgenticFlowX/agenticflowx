...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@agenticflowx/types"
...
import { TOOL_GROUPS } from "@afx/tools"

import { vscode } from "@src/utils/vscode"
import { buildDocLink } from "@src/utils/doc-links"
						...
						<div className="flex gap-2">
							...
							<StandardTooltip content={t("prompts:modes.importMode")}>
								<Button
									...
									<span className="codicon codicon-cloud-download" style={{ fontSize: 16 }} />
								</Button>
							</StandardTooltip>
						</div>
					</div>
							...
							<>
								<Popover open={open} onOpenChange={onOpenChange}>
									<PopoverTrigger asChild>
										<Button
											...
											<span className="codicon codicon-chevron-down opacity-50" />
										</Button>
									</PopoverTrigger>
								...
								<StandardTooltip content={t("prompts:exportMode.title")}>
									<Button
										...
										<span className="codicon codicon-export" style={{ fontSize: 16 }} />
									</Button>
								</StandardTooltip>
							</>
						)}
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.afx/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
