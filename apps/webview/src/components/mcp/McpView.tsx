...
import type { McpServer } from "@agenticflowx/types"

import { vscode } from "@src/utils/vscode"
import { useExtensionState } from "@src/context/ExtensionStateContext"
import { useAppTranslation } from "@src/i18n/TranslationContext"
import { useTooManyTools } from "@src/hooks/use-too-many-tools"
import {
	Button,
	Dialog,
	DialogContent,
			...
			<Section>
				<div
					...
					<Trans i18nKey="mcp:description">
						<VSCodeLink
							href={buildDocLink("features/mcp/using-mcp-in-afx", "mcp_settings")}
				...
				{mcpEnabled && (
					<>
						...
						<div
							...
							<VSCodeLink
								href={buildDocLink(
									"features/mcp/using-mcp-in-afx#editing-mcp-settings-files",
									"mcp_edit_settings",
								)}
								style={{ display: "inline" }}>
