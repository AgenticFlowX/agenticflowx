...
import { useAutoApprovalToggles } from "@/hooks/use-auto-approval-toggles"
import { useAutoApprovalState } from "@/hooks/use-auto-approval-state"
			...
			<StandardTooltip content={tooltipText}>
				<PopoverTrigger
					...
					{!effectiveAutoApprovalEnabled ? (
						<span className="codicon codicon-close size-3 flex-shrink-0" />
					) : (
						<span className="codicon codicon-check-all size-3 flex-shrink-0" />
					)}
				...
				<div className="flex flex-col w-full">
					...
					<div className="p-3 border-b border-vscode-dropdown-border">
						<div className="flex items-center justify-between gap-1 pr-1 pb-2">
							...
							<span
								className="codicon codicon-settings-gear inline mb-0.5 mr-1 size-4 cursor-pointer"
					...
					<div className="flex flex-row items-center justify-between px-2 py-2 border-t border-vscode-dropdown-border">
						<div className="flex flex-row gap-1">
							<Button
								...
								<span className="codicon codicon-checklist w-3.5 h-3.5" />
							...
							<Button
								...
								<span className="codicon codicon-list-unordered w-3.5 h-3.5" />
