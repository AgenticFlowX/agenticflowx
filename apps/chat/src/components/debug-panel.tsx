...
const SCENARIO_GROUPS: ScenarioGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "tool-edit-markdown-file", label: "edit markdown", accent: "bg-afx-brand" },
      { name: "tool-edit-many-files", label: "edit ×8", accent: "bg-afx-brand" },
      { name: "tool-edit-many-files-10", label: "edit ×10", accent: "bg-afx-brand" },
      { name: "tool-edit-many-files-20", label: "edit ×20", accent: "bg-afx-brand" },
      { name: "tool-edit-many-files-50", label: "edit ×50", accent: "bg-afx-brand" },
      { name: "tool-edit-mixed-34-21", label: "edit 34/21", accent: "bg-afx-brand" },
