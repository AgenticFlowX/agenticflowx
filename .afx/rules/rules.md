...
1. Test Coverage:
    ...
    - Tests must be run from inside the correct workspace:
        ...
        - UI tests: `cd packages/webapp-core && npx vitest run src/path/to/test-file`
...
3. Styling Guidelines:
    ...
    - VSCode CSS variables must be added to packages/webapp-core/src/index.css before using them in Tailwind classes
