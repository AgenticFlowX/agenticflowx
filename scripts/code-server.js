...
/**
 * Serve script for AgenticFlowX extension development
 *
 * Usage:
...
const VSIX_PATH = path.join(os.tmpdir(), "agenticflowx-serve.vsix")
...
async function main() {
	console.log(`\n${BOLD}🔧 AgenticFlowX - Install Extension${RESET}\n`)
