...
- [ ] First-run Settings shows hosted API key, custom endpoint, and Pi RPC setup lanes
...
| Anthropic/OpenAI    OpenAI-compatible     Local Pi CLI       |
| Gemini/DeepSeek     Ollama/LM Studio      model catalog      |
|                                                              |
| Hosted keys: 0   Custom: 0   Pi RPC: off                    |
| Keys are saved in VS Code SecretStorage.                     |
+--------------------------------------------------------------+
| Modes                                                        |
|                                                              |
