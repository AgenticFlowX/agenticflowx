...
| 2026-05-08T12:18:59.000Z | 4.x  | Scaffolded  | docs/specs/214-app-chat-settings/{spec,design,tasks}.md, docs/research/pi/res-pi-models-json-settings-ui.md, docs/adr/ADR-0008-afx-custom-providers-adapter-pattern.md (planned)                                                                                                                                                       | [x]   | []    |
