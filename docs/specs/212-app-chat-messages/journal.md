...
- `2026-05-05T07:49:21.000Z` `/afx-dev debug`: P0 manual compaction toast bug. The compaction result summary could be rendered as a transient toast description, making the notification tall enough to obscure the chat timeline. Kept the detailed compaction summary in the timeline row and changed the toast to a short confirmation. Added regression coverage that long summaries do not render in the toast. `[FR-1] [FR-6] [NFR-3] [DES-MESSAGES-MOCKUP-SYSTEM] [DES-MESSAGES-COMPONENT-TIMELINE]`
- `2026-05-05T08:37:39.000Z` `/afx-dev docs`: synchronized message ASCII references for compaction. The timeline mockup now states that the full summary stays in the transcript, and `[DES-MESSAGES-MOCKUP-COMPACTION-TOAST]` captures the intentionally short transient toast. `[FR-6] [NFR-3] [DES-MESSAGES-MOCKUP-SYSTEM] [DES-MESSAGES-MOCKUP-COMPACTION-TOAST]`
