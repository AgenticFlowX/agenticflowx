...
| ---------- | -------------------------------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ----- |
| 2026-04-26 | Phase 1–2 — scaffold                   | Completed | docs/specs/300-infra-pi/ (scaffolded)                                                                                                                                 | [x]   | []    |
| 2026-04-26 | Phase 3 — packages/agent/pi (ADR-0002) | Completed | packages/agent/pi/ (created), apps/vscode/src/engine/pi-{client,manager}.ts (deleted), pnpm-workspace.yaml, vitest.workspace.ts, AGENTS.md, spec.md (v1.1), design.md | [x]   | []    |
| 2026-04-26 | Review fixes                           | Completed | packages/agent/pi/src/rpc-manager.ts, spec.md, design.md, journal.md                                                                                                  | [x]   | []    |
| 2026-04-26 | AFX command/config cleanup             | Completed | packages/agent/pi/src/rpc-manager.ts, spec.md, design.md, tasks.md                                                                                                    | [x]   | []    |
