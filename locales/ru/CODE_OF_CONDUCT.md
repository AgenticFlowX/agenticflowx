...
сообщить, связавшись с командой проекта по адресу https://github.com/AgenticFlowX/agenticflowx/issues. Все жалобы
...
Этот Кодекс поведения адаптирован из [Соглашения о поведении участников][homepage], версия 1.4,
