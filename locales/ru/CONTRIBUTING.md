...
# Вклад в AgenticFlowX

AgenticFlowX — это проект, управляемый сообществом, и мы глубоко ценим каждый вклад. Чтобы упростить совместную работу, мы работаем на основе [подхода «сначала задача»](#подход-сначала-задача), что означает, что все [запросы на слияние (PR)](#подача-запроса-на-слияние) должны быть сначала связаны с задачей на GitHub. Пожалуйста, внимательно ознакомьтесь с этим руководством.
...
### 3. Присоединяйтесь к сообществу AgenticFlowX

- **Основной:** Присоединяйтесь к нашему [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) и напишите личное сообщение **the maintainers**.
- **Альтернатива:** Опытные участники mogą напрямую взаимодействовать через [Проекты GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение **the maintainers** в [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions), чтобы вас назначили. Назначение будет подтверждено в ветке.
- **PR должны ссылаться на задачу.** Несвязанные PR могут быть закрыты.

### Решение, над чем работать

- Проверьте [Проект GitHub](https://github.com/orgs/AgenticFlowX/projects/1) на наличие задач «Задача [не назначена]».
- Для документации посетите [Документацию AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией AgenticFlowX (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/ВАШЕ_ИМЯ_ПОЛЬЗОВАТЕЛЯ/agenticflowx.git
```
...
- Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение **the maintainers** в [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). Назначение будет подтверждено в ветке.
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием AgenticFlowX.
