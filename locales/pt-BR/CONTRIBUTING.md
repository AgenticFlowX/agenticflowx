...
### 3. Junte-se à comunidade AgenticFlowX

- **Principal:** Junte-se ao nosso [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) e envie uma DM para **the maintainers**.
- **Alternativa:** Contribuidores experientes могут se envolver diretamente através dos [Projetos do GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Quer trabalhar nisso?** Comente "Reivindicando" na issue e envie uma DM para **the maintainers** no [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) para ser atribuído. A atribuição será confirmada no tópico.
- **Os PRs devem ser vinculados à issue.** PRs não vinculados podem ser fechados.

### Decidindo no que trabalhar

- Verifique o [Projeto do GitHub](https://github.com/orgs/AgenticFlowX/projects/1) para issues "Issue [Não atribuída]".
- Para documentação, visite [Documentação do AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do AgenticFlowX (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular através de [avisos de segurança](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/SEU_NOME_DE_USUARIO/agenticflowx.git
```
...
- Deve fazer referência a uma Issue do GitHub atribuída. Para ser atribuído: comente "Reivindicando" na issue e envie uma DM para **the maintainers** no [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). A atribuição será confirmada no tópico.
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do AgenticFlowX.
