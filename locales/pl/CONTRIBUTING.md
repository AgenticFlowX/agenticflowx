...
# Wkład w AgenticFlowX

AgenticFlowX to projekt społecznościowy i głęboko cenimy każdy wkład. Aby usprawnić współpracę, działamy w oparciu o [podejście „najpierw zgłoszenie”](#podejście-najpierw-zgłoszenie), co oznacza, że wszystkie [żądania ściągnięcia (PR)](#przesyłanie-żądania-ściągnięcia) muszą być najpierw połączone ze zgłoszeniem na GitHubie. Prosimy o uważne zapoznanie się z tym przewodnikiem.
...
### 3. Dołącz do społeczności AgenticFlowX

- **Głównie:** Dołącz do naszego [Discorda](https://github.com/AgenticFlowX/agenticflowx/discussions) i wyślij wiadomość prywatną do **the maintainers**.
- **Alternatywa:** Doświadczeni współtwórcy mogą angażować się bezpośrednio za pośrednictwem [projektów na GitHubie](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Sprawdź istniejące zgłoszenia**: Przeszukaj [zgłoszenia на GitHubie](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Chcesz nad tym popracować?** Skomentuj „Zgłaszam się” w zgłoszeniu i wyślij wiadomość prywatną do **the maintainers** na [Discordzie](https://github.com/AgenticFlowX/agenticflowx/discussions), aby zostać przypisanym. Przypisanie zostanie potwierdzone w wątku.
- **PR-y muszą być połączone зі zgłoszeniem.** Niepołączone PR-y mogą zostać zamknięte.

### Decydowanie, nad czym pracować

- Sprawdź [projekt na GitHubie](https://github.com/orgs/AgenticFlowX/projects/1) pod kątem zgłoszeń „Zgłoszenie [Nieprzypisane]”.
- Aby uzyskać dokumentację, odwiedź [dokumentację AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Zgłaszanie błędów

- Najpierw sprawdź istniejące raporty.
- Utwórz nowy błąd, używając szablonu [„Zgłoszenie błędu”](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) z:
    - Jasnymi, ponumerowanymi krokami reprodukcji
    - Oczekiwanym a rzeczywistym wynikiem
    - Wersją AgenticFlowX (wymagane); dostawcą/modelem sztucznej inteligencji, jeśli ma to zastosowanie
- **Problemy z bezpieczeństwem**: Zgłoś je prywatnie za pośrednictwem [zaleceń dotyczących bezpieczeństwa](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/TWOJA_NAZWA_UŻYTKOWNIKA/agenticflowx.git
```
...
- Musi odnosić się do przypisanego zgłoszenia na GitHubie. Aby zostać przypisanym: skomentuj „Zgłaszam się” w zgłoszeniu i wyślij wiadomość prywatną do **the maintainers** na [Discordzie](https://github.com/AgenticFlowX/agenticflowx/discussions). Przypisanie zostanie potwierdzone w wątku.
...
Przesyłając wkład, zgadzasz się, że Twoje wkłady będą licencjonowane na podstawie licencji Apache 2.0, zgodnie z licencją AgenticFlowX.
