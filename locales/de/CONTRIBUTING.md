...
### 3. Tritt der AgenticFlowX Community bei

- **Primär:** Tritt unserem [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) bei und schreibe eine DM an **the maintainers**.
- **Alternative:** Erfahrene Mitwirkende können sich direkt über [GitHub-Projekte](https://github.com/orgs/AgenticFlowX/projects/1) beteiligen.
...
- **Überprüfe bestehende Issues**: Suche in den [GitHub Issues](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Möchtest du daran arbeiten?** Kommentiere „Claiming“ im Issue und schreibe eine DM an **the maintainers** auf [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions), um zugewiesen zu werden. Die Zuweisung wird im Thread bestätigt.
- **PRs müssen auf das Issue verweisen.** Nicht verknüpfte PRs können geschlossen werden.

### Entscheiden, woran du arbeiten möchtest

- Überprüfe das [GitHub-Projekt](https://github.com/orgs/AgenticFlowX/projects/1) auf „Issue [Unassigned]“-Issues.
- Für Dokumentation besuche [AgenticFlowX Docs](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Fehler melden

- Überprüfe zuerst, ob bereits Berichte vorhanden sind.
- Erstelle einen neuen Fehler mit der [Vorlage „Fehlerbericht“](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) mit:
    - Klaren, nummerierten Reproduktionsschritten
    - Erwartetes vs. tatsächliches Ergebnis
    - AgenticFlowX-Version (erforderlich); API-Anbieter/Modell, falls relevant
- **Sicherheitsprobleme**: Melde sie privat über [Sicherheitshinweise](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/DEIN_BENUTZERNAME/agenticflowx.git
```
...
- Muss auf ein zugewiesenes GitHub-Issue verweisen. Um zugewiesen zu werden: Kommentiere „Claiming“ im Issue und schreibe eine DM an **the maintainers** auf [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). Die Zuweisung wird im Thread bestätigt.
...
Indem du einen Beitrag leistest, stimmst du zu, dass deine Beiträge unter der Apache-2.0-Lizenz lizenziert werden, die mit der Lizenzierung von AgenticFlowX übereinstimmt.
