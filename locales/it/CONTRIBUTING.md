...
### 3. Unisciti alla community di AgenticFlowX

- **Principale:** Unisciti al nostro [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) e invia un DM a **the maintainers**.
- **Alternativa:** I contributori esperti possono interagire direttamente tramite i [progetti GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Controlla le issue esistenti**: cerca nelle [issue di GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Vuoi lavorarci?** Commenta "Rivendico" sull'issue e invia un DM a **the maintainers** su [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) per essere assegnato. L'assegnazione verrà confermata nel thread.
- **Le PR devono essere collegate all'issue.** Le PR non collegate possono essere chiuse.

### Decidere su cosa lavorare

- Controlla il [progetto GitHub](https://github.com/orgs/AgenticFlowX/projects/1) per le issue "Issue [Non assegnata]".
- Per la documentazione, visita [AgenticFlowX Docs](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Segnalazione di bug

- Controlla prima le segnalazioni esistenti.
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) con:
    - Passaggi di riproduzione chiari e numerati
    - Risultato previsto vs effettivo
    - Versione di AgenticFlowX (obbligatoria); provider/modello di intelligenza artificiale se pertinente
- **Problemi di sicurezza**: segnala in privato tramite [avvisi di sicurezza](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/TUO_NOME_UTENTE/agenticflowx.git
```
...
- Deve fare riferimento a un'issue di GitHub assegnata. Per essere assegnato: commenta "Rivendico" sull'issue e invia un DM a **the maintainers** su [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). L'assegnazione verrà confermata nel thread.
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di AgenticFlowX.
