...
# AgenticFlowX'a Katkıda Bulunma

AgenticFlowX topluluk tarafından yürütülen bir projedir ve her katkıyı derinden takdir ediyoruz. İşbirliğini kolaylaştırmak için [Önce Sorun Yaklaşımı](#önce-sorun-yaklaşımı) temelinde çalışıyoruz, bu da tüm [Çekme İsteklerinin (PR'ler)](#bir-çekme-isteği-gönderme) önce bir GitHub Sorununa bağlanması gerektiği anlamına gelir. Lütfen bu kılavuzu dikkatlice inceleyin.
...
### 3. AgenticFlowX Topluluğuna Katılın

- **Birincil:** [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) sunucumuza katılın ve **the maintainers**'a DM gönderin.
- **Alternatif:** Deneyimli katkıda bulunanlar doğrudan [GitHub Projeleri](https://github.com/orgs/AgenticFlowX/projects/1) aracılığıyla etkileşimde bulunabilirler.
...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/AgenticFlowX/agenticflowx/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- **Üzerinde çalışmak ister misiniz?** Soruna "Talep ediyorum" yorumu yapın ve atanmak için [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) üzerinden **the maintainers**'a DM gönderin. Atama, başlıkta teyit edilecektir.
- **PR'ler soruna bağlanmalıdır.** Bağlantısız PR'ler kapatılabilir.

### Ne Üzerinde Çalışılacağına Karar Verme

- "Sorun [Atanmamış]" sorunları için [GitHub Projesi](https://github.com/orgs/AgenticFlowX/projects/1)'ni kontrol edin.
- Belgeler için [AgenticFlowX Belgeleri](https://github.com/AgenticFlowX/agenticflowx-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) kullanarak yeni bir hata oluşturun:
    - Açık, numaralandırılmış yeniden oluşturma adımları
    - Beklenen vs gerçek sonuç
    - AgenticFlowX sürümü (gerekli); ilgiliyse API sağlayıcısı/modeli
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new) aracılığıyla özel olarak bildirin.
...
```
git clone https://github.com/KULLANICI_ADINIZ/agenticflowx.git
```
...
- Atanmış bir GitHub Sorununa atıfta bulunmalıdır. Atanmak için: soruna "Talep ediyorum" yorumu yapın ve [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) üzerinden **the maintainers**'a DM gönderin. Atama, başlıkta teyit edilecektir.
...
Katkıda bulunarak, katkılarınızın AgenticFlowX'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
