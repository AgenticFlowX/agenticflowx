...
# Đóng góp cho AgenticFlowX

AgenticFlowX là một dự án do cộng đồng điều khiển và chúng tôi vô cùng trân trọng mọi đóng góp. Để hợp lý hóa việc cộng tác, chúng tôi hoạt động trên cơ sở [Ưu tiên vấn đề](#cách-tiếp-cận-ưu-tiên-vấn-đề), có nghĩa là tất cả các [Yêu cầu kéo (PR)](#gửi-yêu-cầu-kéo) trước tiên phải được liên kết với một Vấn đề trên GitHub. Vui lòng xem kỹ hướng dẫn này.
...
### 3. Tham gia cộng đồng AgenticFlowX

- **Chính:** Tham gia [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) của chúng tôi và nhắn tin trực tiếp cho **the maintainers**.
- **Thay thế:** Những người đóng góp có kinh nghiệm có thể tham gia trực tiếp qua [Dự án GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Kiểm tra các vấn đề hiện có**: Tìm kiếm trong [Vấn đề trên GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Bạn muốn làm việc với nó?** Bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **the maintainers** trên [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) để được giao. Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
- **PR phải liên kết đến vấn đề.** Các PR không được liên kết có thể bị đóng.

### Quyết định nên làm gì

- Kiểm tra [Dự án GitHub](https://github.com/orgs/AgenticFlowX/projects/1) để tìm các vấn đề "Vấn đề [Chưa được giao]".
- Để biết tài liệu, hãy truy cập [Tài liệu AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Báo cáo lỗi

- Trước tiên hãy kiểm tra các báo cáo hiện có.
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) với:
    - Các bước tái tạo rõ ràng, được đánh số
    - Kết quả mong đợi so với thực tế
    - Phiên bản AgenticFlowX (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
- **Vấn đề bảo mật**: Báo cáo riêng tư qua [tư vấn bảo mật](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/TÊN_NGƯỜI_DÙNG_CỦA_BẠN/agenticflowx.git
```
...
- Phải tham chiếu đến một Vấn đề GitHub đã được giao. Để được giao: bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **the maintainers** trên [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của AgenticFlowX.
