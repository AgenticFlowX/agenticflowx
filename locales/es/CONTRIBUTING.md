...
### 3. Únase a la comunidad de AgenticFlowX

- **Principal:** Únase a nuestro [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) y envíe un mensaje directo a **the maintainers**.
- **Alternativa:** Los colaboradores experimentados pueden participar directamente a través de [Proyectos de GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Compruebe las incidencias existentes**: busque en [Incidencias de GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **¿Quiere trabajar en ello?** Comente "Reclamando" en la incidencia y envíe un mensaje directo a **the maintainers** en [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) para que se le asigne. La asignación se confirmará en el hilo.
...
- Consulte el [Proyecto de GitHub](https://github.com/orgs/AgenticFlowX/projects/1) para ver las incidencias "Incidencia [Sin asignar]".
- Para la documentación, visite [Documentos de AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Informar de errores

- Compruebe primero si existen informes.
- Cree un nuevo error utilizando la [plantilla "Informe de error"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) con:
    - Pasos de reproducción claros y numerados
    - Resultado esperado vs. real
    - Versión de AgenticFlowX (obligatorio); proveedor/modelo de API si es relevante
- **Problemas de seguridad**: informe de forma privada a través de [avisos de seguridad](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/SU_NOMBRE_DE_USUARIO/agenticflowx.git
```
...
- Debe hacer referencia a una incidencia de GitHub asignada. Para que se le asigne: comente "Reclamando" en la incidencia y envíe un mensaje directo a **the maintainers** en [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). La asignación se confirmará en el hilo.
...
Al contribuir, acepta que sus contribuciones se licenciarán bajo la Licencia Apache 2.0, de acuerdo con la licencia de AgenticFlowX.
