...
### 3. Bergabunglah dengan Komunitas AgenticFlowX

- **Utama:** Bergabunglah dengan [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) kami dan kirim DM ke **the maintainers**.
- **Alternatif:** Kontributor berpengalaman dapat terlibat langsung melalui [Proyek GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Periksa masalah yang ada**: Cari di [Masalah GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Ingin mengerjakannya?** Beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **the maintainers** di [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) untuk ditugaskan. Penugasan akan dikonfirmasi di utas.
- **PR harus menautkan ke masalah.** PR yang tidak tertaut dapat ditutup.

### Memutuskan Apa yang Akan Dikerjakan

- Periksa [Proyek GitHub](https://github.com/orgs/AgenticFlowX/projects/1) untuk masalah "Masalah [Belum Ditugaskan]".
- Untuk dokumentasi, kunjungi [Dokumentasi AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Melaporkan Bug

- Periksa laporan yang ada terlebih dahulu.
- Buat bug baru menggunakan [template "Laporan Bug"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) dengan:
    - Langkah-langkah reproduksi yang jelas dan bernomor
    - Hasil yang diharapkan vs aktual
    - Versi AgenticFlowX (wajib); penyedia/model API jika relevan
- **Masalah keamanan**: Laporkan secara pribadi melalui [saran keamanan](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/NAMA_PENGGUNA_ANDA/agenticflowx.git
```
...
- Harus merujuk pada Masalah GitHub yang ditugaskan. Untuk ditugaskan: beri komentar "Mengklaim" pada masalah tersebut dan kirim DM ke **the maintainers** di [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). Penugasan akan dikonfirmasi di utas.
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi AgenticFlowX.
