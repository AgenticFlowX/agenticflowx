...
# Contribuer à AgenticFlowX

AgenticFlowX est un projet communautaire, et nous apprécions profondément chaque contribution. Pour simplifier la collaboration, nous fonctionnons sur une base [d'abord l'issue](#approche-issue-first), ce qui signifie que toutes les [Pull Requests (PRs)](#soumettre-une-pull-request) doivent d'abord être liées à une Issue GitHub. Veuillez lire attentivement ce guide.
...
### 3. Rejoignez la communauté AgenticFlowX

- **Principal :** Rejoignez notre [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) et envoyez un DM à **the maintainers**.
- **Alternative :** Les contributeurs expérimentés peuvent s'engager directement via les [Projets GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Vérifiez les issues existantes** : Recherchez dans les [Issues GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Vous voulez y travailler ?** Commentez "Claiming" sur l'issue et envoyez un DM à **the maintainers** sur [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) pour être assigné. L'assignation sera confirmée dans le fil de discussion.
- **Les PRs doivent être liées à l'issue.** Les PRs non liées peuvent être fermées.

### Décider sur quoi travailler

- Consultez le [Projet GitHub](https://github.com/orgs/AgenticFlowX/projects/1) pour les issues "Issue [Non assignée]".
- Pour la documentation, visitez [AgenticFlowX Docs](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Signaler des bugs

- Vérifiez d'abord les rapports existants.
- Créez un nouveau bug en utilisant le [modèle "Rapport de bug"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) avec :
    - Des étapes de reproduction claires et numérotées
    - Résultat attendu vs réel
    - Version de AgenticFlowX (requise) ; fournisseur/modèle d'API si pertinent
- **Problèmes de sécurité** : Signalez-les en privé via les [avis de sécurité](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/VOTRE_NOM_UTILISATEUR/agenticflowx.git
```
...
- Doit faire référence à une Issue GitHub assignée. Pour être assigné : commentez "Claiming" sur l'issue et envoyez un DM à **the maintainers** sur [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). L'assignation sera confirmée dans le fil de discussion.
...
En contribuant, vous acceptez que vos contributions soient sous licence Apache 2.0, conformément à la licence de AgenticFlowX.
