...
如發生辱罵、騷擾或其他不可接受的行為，請透過 https://github.com/AgenticFlowX/agenticflowx/issues 聯絡專案團隊回報。所有申訴都將被審查和調查，並做出必要且合適的回應。專案團隊有義務為事件回報者保密。具體執行政策的更多細節可能另行公佈。

未遵守或未切實執行本行為準則的專案維護者，可能會面臨由專案領導團隊其他成員所決定的暫時或永久處分。

## 來源說明

本行為準則改編自 [貢獻者公約][homepage] 第 1.4 版的 原文可參考：
