...
# Contribuir a AgenticFlowX

AgenticFlowX és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
### 3. Uniu-vos a la comunitat de AgenticFlowX

- **Principal:** Uniu-vos al nostre [AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx/discussions) i envieu un missatge directe a **the maintainers**.
- **Alternativa:** Els col·laboradors experimentats poden participar directament a través de [Projectes de GitHub](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Comproveu les incidències existents**: cerqueu a [Incidències de GitHub](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Voleu treballar-hi?** Comenteu "Reclamant" a la incidència i envieu un missatge directe a **the maintainers** a [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) per ser assignat. L'assignació es confirmarà al fil.
...
- Consulteu el [Projecte de GitHub](https://github.com/orgs/AgenticFlowX/projects/1) per a incidències "Incidència [No assignada]".
- Per a documents, visiteu [Documents de AgenticFlowX](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Informar d'errors

- Comproveu primer si hi ha informes existents.
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) amb:
    - Passos de reproducció clars i numerats
    - Resultat esperat vs real
    - Versió de AgenticFlowX (obligatori); proveïdor/model d'API si és rellevant
- **Problemes de seguretat**: informeu de manera privada a través d' [avisos de seguretat](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/EL_TEU_NOM_USUARI/agenticflowx.git
```
...
- Ha de fer referència a una incidència de GitHub assignada. Per ser assignat: comenteu "Reclamant" a la incidència i envieu un missatge directe a **the maintainers** a [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). L'assignació es confirmarà al fil.
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de AgenticFlowX.
