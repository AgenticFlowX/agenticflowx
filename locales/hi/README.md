...
<p align="center">
  <em>जल्दी मदद पाएं → <a href="https://github.com/AgenticFlowX/agenticflowx/discussions">डिस्कॉर्ड से जुड़ें</a> • एसिंक पसंद है? → <a href="https://github.com/AgenticFlowX/agenticflowx/discussions/">GitHub Discussions से जुड़ें</a></em>
</p>
...
- OpenAI GPT-5.4 और GPT-5.3 Chat Latest के लिए सपोर्ट जोड़ा गया है, ताकि आप AgenticFlowX में OpenAI के सबसे नए chat models इस्तेमाल कर सकें।
...
## AgenticFlowX आपके लिए क्या कर सकता है?
...
और जानो: [मोड्स का इस्तेमाल](https://github.com/AgenticFlowX/agenticflowx/basic-usage/using-modes) • [कस्टम मोड्स](https://github.com/AgenticFlowX/agenticflowx/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://github.com/AgenticFlowX/agenticflowx/tutorial-videos">अधिक त्वरित ट्यूटोरियल और फ़ीचर वीडियो...</a>
</p>

## संसाधन

- **[दस्तावेज़ीकरण](https://github.com/AgenticFlowX/agenticflowx):** AgenticFlowX को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
- **[यूट्यूब चैनल](https://github.com/AgenticFlowX/agenticflowx):** ट्यूटोरियल देखें और सुविधाओं को एक्शन में देखें।
- **[डिस्कॉर्ड सर्वर](https://github.com/AgenticFlowX/agenticflowx/discussions):** रीयल-टाइम सहायता और चर्चा के लिए समुदाय में शामिल हों।
- **[रेडिट समुदाय](https://github.com/AgenticFlowX/agenticflowx/discussions):** अपने अनुभव साझा करें और देखें कि दूसरे क्या बना रहे हैं।
- **[गिटहब मुद्दे](https://github.com/AgenticFlowX/agenticflowx/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
- **[सुविधा अनुरोध](https://github.com/AgenticFlowX/agenticflowx/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह AgenticFlowX एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/agenticflowx-<version>.vsix` )।
...
**AgenticFlowX का आनंद लें!** चाहे आप इसे छोटी लगाम में रखें या इसे स्वायत्त रूप से घूमने दें, हम यह देखने के लिए इंतजार नहीं कर सकते कि आप क्या बनाते हैं। यदि आपके कोई प्रश्न या सुविधा के विचार हैं, तो हमारी [रेडिट समुदाय](https://github.com/AgenticFlowX/agenticflowx/discussions/) या [डिस्कॉर्ड](https://github.com/AgenticFlowX/agenticflowx/discussions) पर आएं। हैप्पी कोडिंग!
