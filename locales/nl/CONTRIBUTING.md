...
# Bijdragen aan AgenticFlowX

AgenticFlowX is een door de gemeenschap gedreven project en we waarderen elke bijdrage ten zeerste. Om de samenwerking te stroomlijnen, werken we op basis van een [Issue-First-aanpak](#issue-first-aanpak), wat betekent dat alle [Pull Requests (PR's)](#een-pull-request-indienen) eerst gekoppeld moeten zijn aan een GitHub Issue. Lees deze handleiding zorgvuldig door.
...
### 3. Word lid van de AgenticFlowX-community

- **Primair:** Word lid van onze [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) en stuur een DM naar **the maintainers**.
- **Alternatief:** Ervaren bijdragers kunnen rechtstreeks deelnemen via [GitHub Projects](https://github.com/orgs/AgenticFlowX/projects/1).
...
- **Controleer bestaande issues**: Zoek in [GitHub Issues](https://github.com/AgenticFlowX/agenticflowx/issues).
...
- **Wil je eraan werken?** Reageer met "Claiming" op de issue en stuur een DM naar **the maintainers** op [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions) om toegewezen te worden. De toewijzing wordt in de thread bevestigd.
- **PR's moeten naar de issue linken.** Niet-gekoppelde PR's kunnen worden gesloten.

### Beslissen waaraan je wilt werken

- Controleer het [GitHub Project](https://github.com/orgs/AgenticFlowX/projects/1) voor "Issue [Niet-toegewezen]" issues.
- Ga voor documentatie naar [AgenticFlowX Docs](https://github.com/AgenticFlowX/agenticflowx-Docs).

### Bugs rapporteren

- Controleer eerst bestaande rapporten.
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/AgenticFlowX/agenticflowx/issues/new/choose) met:
    - Duidelijke, genummerde reproductiestappen
    - Verwacht vs. feitelijk resultaat
    - AgenticFlowX-versie (vereist); API-provider/model indien relevant
- **Beveiligingsproblemen**: Rapporteer privé via [beveiligingsadviezen](https://github.com/AgenticFlowX/agenticflowx/security/advisories/new).
...
```
git clone https://github.com/JOUW_GEBRUIKERSNAAM/agenticflowx.git
```
...
- Moet verwijzen naar een toegewezen GitHub Issue. Om toegewezen te worden: reageer met "Claiming" op de issue en stuur een DM naar **the maintainers** op [Discord](https://github.com/AgenticFlowX/agenticflowx/discussions). De toewijzing wordt in de thread bevestigd.
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van AgenticFlowX.
