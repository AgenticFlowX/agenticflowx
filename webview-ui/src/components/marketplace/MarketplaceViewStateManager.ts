 ...
 *
 * This class manages the state for the marketplace view in the AgenticFlowX extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the AgenticFlowX extensions interface
...
export class MarketplaceViewStateManager {
	...
	public async handleMessage(message: any): Promise<void> {
		...
		if (message.type === "state") {
			...
			// The state.marketplaceItems come from AfxProvider, see the file src/core/webview/AfxProvider.ts
