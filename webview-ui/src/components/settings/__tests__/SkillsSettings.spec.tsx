...
const mockSkills: SkillMetadata[] = [
	{
		...
		path: "/workspace/.afx/skills/project-skill/SKILL.md",
		source: "project",
	},
	{
		name: "project-mode-skill",
		description: "A project mode-specific skill",
		path: "/workspace/.afx/skills/project-mode-skill/SKILL.md",
		source: "project",
		modeSlugs: ["architect"],
	},
	{
		...
		path: "/home/.afx/skills/global-skill/SKILL.md",
		source: "global",
	},
]
	...
	it("opens skill file when edit button is clicked", () => {
		...
		const editButtons = buttons.filter(
			(btn) =>
				...
				!btn.querySelector(".codicon-settings-gear") &&
				btn.querySelector(".codicon-edit"),
		)
