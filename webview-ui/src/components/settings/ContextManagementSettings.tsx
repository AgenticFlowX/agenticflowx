...
import { supportPrompt } from "@afx/support-prompt"
	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<SearchableSetting
					settingId="context-show-afxignored-files"
					section="contextManagement"
					label={t("settings:contextManagement.afxignore.label")}>
					<VSCodeCheckbox
						checked={showAfxIgnoredFiles}
						onChange={(e: any) => setCachedStateField("showAfxIgnoredFiles", e.target.checked)}
						data-testid="show-afxignored-files-checkbox">
						<label className="block font-medium mb-1">
							{t("settings:contextManagement.afxignore.label")}
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1 mb-3">
						{t("settings:contextManagement.afxignore.description")}
					</div>
				</SearchableSetting>
