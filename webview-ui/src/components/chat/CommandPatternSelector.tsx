			...
			<button
				...
				<div className="group flex items-center gap-2 cursor-pointer w-full text-left">
					<span
						...
						<span className="codicon codicon-check-all size-3 inline-block mr-2" />
						{t("chat:commandExecution.manageCommands")}
					</span>
					<span
						className={cn(
							"codicon codicon-chevron-up group-hover:opacity-100 size-4 transition-transform",
								...
								<div className="flex items-center gap-1">
									<StandardTooltip
										...
										<button
											...
											<span className="codicon codicon-check size-3.5" />
										</button>
									</StandardTooltip>
									<StandardTooltip
										content={t(
