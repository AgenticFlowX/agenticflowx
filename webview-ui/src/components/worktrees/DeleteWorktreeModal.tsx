...
import type { Worktree } from "@agenticflowx/types"
				...
				<div className="flex flex-col gap-3 overflow-hidden">
					...
					<div className="flex flex-col p-5 gap-2 cursor-default rounded-xl text-vscode-foreground bg-vscode-input-background">
						<p className="flex items-center gap-2 m-0">
							<span className="codicon codicon-git-branch size-4 shrink-0" />
					...
					<div className="flex items-start gap-2 px-5 py-2">
						<span className="codicon codicon-warning size-4 text-vscode-charts-yellow flex-shrink-0" />
