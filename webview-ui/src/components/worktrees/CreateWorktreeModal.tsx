...
import type { WorktreeDefaultsResponse, BranchInfo, WorktreeIncludeStatus } from "@agenticflowx/types"
			...
			<DialogContent className="max-w-lg">
				...
				<div className="flex flex-col gap-3">
					...
					<div className="flex items-center gap-2">
						<span className="codicon codicon-reply size-4 ml-2 shrink-0" />
					...
					<div className="flex items-center gap-2 relative">
						<span className="codicon codicon-folder size-4 ml-2 shrink-0" />
						...
						/>
						<span
							className="codicon codicon-folder-opened size-4 shrink-0 absolute right-3 cursor-pointer hover:opacity-75 transition-opacity"
